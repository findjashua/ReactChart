    ...
    render: function() {
        ...
        return(
            React.createElement("div", null, 
                React.createElement(Toolbar, {metric: this.state.metric, dateRange: this.state.dateRange}), 
                React.createElement(BarChart, {metric: this.state.metric, dateRange: this.state.dateRange})
            )
        )
    },
